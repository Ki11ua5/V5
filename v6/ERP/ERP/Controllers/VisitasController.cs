...
namespace ERP.Controllers
{
    public class VisitasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Fecha,Costo,Latitud,Altitud,Estado,Empresa,Tecnologia,Tipo,EstatusPago,EstatusCobro,FechaMaxima,Folio,Ingeniero,EstadoVisita")] Visita visita)
        {
            ...
            {
                var getempresa=db.Empresas.Find(visita.Empresa);
                var gettipovisita = db.TipoVisitas.Find(visita.Tipo);
                var gettec = db.Tecnologias.Find(visita.Tecnologia);
                
                
                db.Visitas.Add(visita);
                db.SaveChanges();
                string asunto ="Empresa: "+ getempresa.Nombre_Empresa.ToString() + "\n\r" +
                "Tipo de Visita: " + gettipovisita.Nombre_Visita.ToString() + "\n\r"+
                "Tecnologia: " + gettec.Nombre_tec.ToString() + "\n\r" +
                "Coordenadas: " + visita.Latitud + "," + visita.Altitud;
                Utilities.SendMail("giovanni.solucionestj@gmail.com", "solucionestj.info@gmail.com", "Nueva Visita" + visita.Fecha, asunto);
        ...
        {
            var imagenes = from i in db.Imagenes
                           where i.Folio == id
                           select (i);
